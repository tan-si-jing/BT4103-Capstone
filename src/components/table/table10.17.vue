...
<table class="table table-bordered">
  <thead>
      <p style="text-align:left; font-size:18px;"><b>Table 10.17</b></p>
  </thead>
  ...
  <tbody>
    ...
    <tr>
      <td scope = "row" style="text-align:left;">Commuter facility structure (such as landing, staircase, column of Pedestrian Overhead Bridge, 
