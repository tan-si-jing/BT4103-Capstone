<template>
  ...
  <div class="options">
    <div class="button-group">
      ...
      <SearchParamButton text="80" v-bind:isActive="true" @click="storeDesignSpeed('speed80');"/>
      <SearchParamButton text="90" v-bind:isActive="true" @click="storeDesignSpeed('speed90');"/>
    </div>
