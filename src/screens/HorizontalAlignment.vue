        ...
        <tbody>
          ...
          <td scope="row">
            <div class="content">
                ...
                <p style="padding-top:3%"><b class="tab3">10.4.2.3.1</b><b>Simple Curve</b></p>
                ...
                <p style="padding-top:3%"><b class="tab3">10.4.2.3.2</b><b>Compound Curve</b></p>
                    <p>A compound curve consists of two or more curves with deflections in the same direction immediately 
                        ...
                        the following guidelines shall be applied: - <br>
                        a) curve shall have radii greater than 1000m. <br>
                        b) where radii less than 1000m have to be used, the design speed for each curve shall 
                        desirably be within 10km/h of each other. <br>
                        c) on main road, the ratio of the radius of the flatter curve to the sharper curve shall not exceed 1.5:1; and <br>
                        d) at junction intersection and ramp, the ratio of the radius of the flatter curve to the sharper curve can be up to 2:1</p>

                <p style="padding-top:3%"><b class="tab3">10.4.2.3.3</b><b>Reverse Curve</b></p>
                    <p>A reverse curve consists of two curves of deflections in the opposite direction which are 
                        ...
                        reverse curve is not favoured. Where it is necessary, the following guidelines shall be applied. <br>
                        a) the tangent distance in metre between the reverse curves shall not be less than 0.6 times the design speed in km/h. <br>
                        b) up to 50% of the transition may be placed in the curve; and <br>
                        c) where it is not possible to provide the minimum tangent distance in (a), the radius of each curve shall not be 
                        less than minimum radius of V&#178;/127 f, where V is the design speed in km/h and f is the side friction factor.</p>
                
                <p style="padding-top:3%"><b class="tab3">10.4.2.3.4</b><b>Broken-back Curve</b></p>
                    <p>Broken-back curve consists of two curves with deflections in the same direction that is joined by a short tangent 
                        ...
                        or transition curve between the two curves.</p>
                
                <p style="padding-top:3%"><b class="tab3">10.4.2.3.5</b><b>Transition Curve</b></p>
                <p>Transition curve is normally used to join a straight line to a circular curve, although it may be omitted when large 
                    ...
                    rate along the curve. The following design requirements shall be adopted:<br>
                    a) Where the design speed is up to 60km/h, no transition curve is required. Where the design speed is more than 60km/h, 
                    transition curve is not required if the associated shift in circular arc is less than 0.20m.<br>
                    b) The length of the transition curve and shift can be derived from the following: - </p>
                ...
                <p> There are several general controls that shall be considered when designing the horizontal alignment. <br>
                a) Where it becomes necessary to introduce curve of lower standard than the design requirement, 
                the respective design speed between the successive geometric elements shall not differ by more than 10km/h; <br>
                b) Where the radius of a curve is below the design requirement, additional lane width shall be provided to accommodate heavy 
                vehicle (refer to Figure 10.1) off-tracking within the curve; <br>
                c) Curve shall be sufficiently long to avoid the appearance of a kink. Curve shall be at least 150m long for a central angle of 5°, 
                and the minimum length shall be increased by 30m for each degree decrease in the central angle; <br>
                d) Opening for vehicle turning at centre median along horizontal curve shall not be provided if the intersection 
                sight distance is not achievable; and <br>
                e) on a horizontal curve, there shall be no obstruction i.e. longitudinal barrier, tree, shrub, embankment, 
            ...
            <div class="grid-container">
              ...
              <div class="grid-item inner-grid-container">
                ...
                <div class="grid-item">
                  ...
                  <br>
                   <a href="https://www.lta.gov.sg/content/dam/ltagov/industry_innovations/industry_matters/development_construction_resources/civil_standards/pdf/EGD09106A2_Overall.pdf#page=206">CDC 10.4.2.3.3-10.4.2.3.5 (page 206)</a>
                  <br>
                  <a href="https://www.lta.gov.sg/content/dam/ltagov/industry_innovations/industry_matters/development_construction_resources/civil_standards/pdf/EGD09106A2_Overall.pdf#page=207">CDC 10.4.2.3.5 (page 207)</a>
                  <br>
