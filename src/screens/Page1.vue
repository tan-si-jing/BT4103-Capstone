          ...
          <td scope="row">
            <div class="content">
              ...
              <p style="padding-top:3%"><b class="tab2">9</b><b>Signs</b></p>
                ...
                <p class="tab5">9.1.4 Letters for Directional Signs - Lower Case (Sheet 2 of 2)</p>
                <p class="tab5">9.1.5 Number for Directional Signs</p>
                ...
                <p class="tab5">9.4.4 Traffic Warning Signs (Sheet 4 of 9)</p>
                <p class="tab5">9.4.5 Traffic Warning Signs (Sheet 5 of 9)</p>
                <p class="tab5">9.4.6 Traffic Warning Signs (Sheet 6 of 9)</p>
                ...
                <p class="tab5">9.5.4 Traffic Informatory Signs (Sheet 4 of 17)</p>
                <p class="tab5">9.5.5 Traffic Informatory Signs (Sheet 5 of 17)</p>
                <p class="tab5">9.5.6 Traffic Informatory Signs (Sheet 6 of 17)</p>
                <p class="tab5">9.5.7 Traffic Informatory Signs (Sheet 7 of 17)</p>
                <p class="tab5">9.5.8 Traffic Informatory Signs (Sheet 8 of 17)</p>
                <p class="tab5">9.5.9 Traffic Informatory Signs (Sheet 9 of 17)</p>
                <p class="tab5">9.5.10 Traffic Informatory Signs (Sheet 10 of 17)</p>
                <p class="tab5">9.5.11 Traffic Informatory Signs (Sheet 11 of 17)</p>
                <p class="tab5">9.5.12 Traffic Informatory Signs (Sheet 12 of 17)</p>
                <p class="tab5">9.5.13 Traffic Informatory Signs (Sheet 13 of 17)</p>
                <p class="tab5">9.5.14 Traffic Informatory Signs (Sheet 14 of 17)</p>
                <p class="tab5">9.5.15 Traffic Informatory Signs (Sheet 15 of 17)</p>
                <p class="tab5">9.5.16 Traffic Informatory Signs (Sheet 16 of 17)</p>
                ...
                <p class="tab5">9.6.4 Street Name Sign - Street Name Sign on Single Support Post</p> 
                <p class="tab5">9.6.5 Street Name Sign - Street Name Sign on Double Support Post</p>
                <p class="tab5">9.6.6 Street Name Sign - Cantilever Street Name Sign on Vertical Support Post</p>
                <p class="tab5">9.6.7 Street Name Sign - Cantilever Street Name Sign on Existing Lamp Post</p>
                <p class="tab5">9.6.8 Street Name Sign Single Side Street Name Sign on Existing Lamp Post</p>
                <p class="tab5">9.6.9 Street Name Sign on Traffic Post</p>
                ...
                <p class="tab5">9.7.4 Treatment at Development/ Carpark Access (Sheet 2 of 2)</p>
                <p class="tab5">9.7.5 Bicycle Crossing</p>
                <p class="tab5">9.7.6 Shared Track</p>
                <p class="tab5">9.7.7 Treatment at Bus Stop With Bus Bay</p>
