<template>
  <table class="table table-borderless">
    <thead class="table">
      <tr>
      <td id="signs" class="sectionHeader">&nbsp;&nbsp; 9 &nbsp; Signs
